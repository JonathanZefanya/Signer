 ...
 */
 function loadDocuments(password){
    ...
    if (typeof docType === 'undefined') {
        console.warn('docType is not defined, defaulting to "documents"');
        docType = "documents";
    }
    if (typeof documentsUrl === 'undefined' || typeof templatesUrl === 'undefined') {
        console.error('Required URLs (documentsUrl or templatesUrl) are not defined');
        return;
    }
