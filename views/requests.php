                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    @if ( is_object($request['receiver']) && isset($request['receiver']->avatar) && !empty($request['receiver']->avatar) )
                                ...
                                <td>
                                    @if ( is_object($request['receiver']) && isset($request['receiver']->fname) )
                                    ...
                                    @endif
                                    @if ( is_object($request['sender']) && isset($request['sender']->fname) )
                                    <br>Sent by: {{ $request['sender']->fname }} {{ $request['sender']->lname }}
                                    @else
                                    <br>Sent by: Unknown User
                                    @endif
                                </td>
                                <td><a href="{{ url('Document@open').$request['file']->document_key }}">{{ $request['file']->name }}</a></td>
                                <td><strong>Requested: </strong>{{ date("F j, Y. H:i", strtotime($request['data']->send_time)) }}
                                    @if ( $request['data']->status != "Pending" )
                                    <br><strong>Updated: </strong>{{ date("F j, Y. H:i", strtotime($request['data']->update_time)) }} 
                                    @endif
                                </td>
                                <td class="text-center">
