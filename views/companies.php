                    ...
                    <table class="table display companies-list" id="data-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ( is_object($company['owner']) && isset($company['owner']->fname) )
                                    <strong>{{ $company['owner']->fname }} {{ $company['owner']->lname }}</strong><br>{{ $company['owner']->email }}
                                    @else
                                    <strong>No Owner</strong><br><span class="text-muted">Owner not found</span>
                                    @endif
                                </td>
